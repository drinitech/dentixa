// Mirrors app/(auth)/layout.tsx's centered-card chrome — this page can't
// live inside that route group (it needs the /c/[slug] segment above it for
// TenantProvider to set the ambient tenant slug), so the wrapper is
